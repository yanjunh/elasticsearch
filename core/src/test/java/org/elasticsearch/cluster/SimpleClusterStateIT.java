...
public class SimpleClusterStateIT extends ESIntegTestCase {
    ...
    public void testLargeClusterStatePublishing() throws Exception {
        ...
        assertAcked(client().admin().indices().prepareCreate("test")
                .setSettings(IndexMetaData.SETTING_NUMBER_OF_SHARDS, numberOfShards, IndexMetaData.SETTING_NUMBER_OF_REPLICAS, 0, MapperService.INDEX_MAPPING_TOTAL_FIELDS_LIMIT_SETTING, 0)
